...
// Create placeholder pages for Collection and Shop
const Collection = () => (
  <div className="container mx-auto px-4 py-8">
    <h1 className="text-3xl font-bold text-white mb-6">Player Collection</h1>
    <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl shadow-xl p-6">
      <p className="text-white text-lg">Your player collection will be displayed here.</p>
    </div>
  </div>
);
